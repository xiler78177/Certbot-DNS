...
# ==============================================================================
# 服务器初始化与管理脚本 (v7.5 - Gemini-Mod)
#
# 更新日志 v7.5:
# 1. [体验优化] 脚本启动时自动检测并安装核心依赖 (curl, jq, snapd 等)，无需手动点击。
# 2. [菜单调整] 将“安装基础依赖”改为“手动重装依赖”，平时无需操作。
# 3. [功能保持] 包含 v7.4 的所有修复 (Nginx 标准配置、Web 服务自动重载、Backspace 修复等)。
# ==============================================================================
...
# Generated by server-manage.sh (v7.5) for ${DOMAIN}
